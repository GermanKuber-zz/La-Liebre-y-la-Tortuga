...
{
    public class FivePlayersQuantityType : FourPlayersQuantityType
    {
        public override int NumberOfPlayers => 5;

        public sealed override IPlayer PlayerFive { get; }

        public FivePlayersQuantityType(IPlayer playerOne, IPlayer playerTwo, IPlayer playerThree, IPlayer playerFour, IPlayer playerFive)
